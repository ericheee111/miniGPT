...
- Git SHA: `ed7da8722d6fed89b1b05ed99c8fc7ca4e6231d6`
...
- median measured tokens/s: 9178.72
- peak process RSS: 485.35 MiB
...
**Deterministic local-structure observation:** the final sample contains 41 alphabetic runs of at least two characters versus 30 in the untrained baseline (more by this fixed heuristic). This is evidence about local word-like structure, not fluency or generalization.
...
2. Run the two commands recorded above from Git SHA `ed7da8722d6fed89b1b05ed99c8fc7ca4e6231d6`.
